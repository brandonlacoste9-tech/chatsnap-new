...
export const fr: Dict = {
  ...
  retake: "Reprendre",
  next: "Suivant",
  duration: "Temps de visionnage",
  durationHint: "Ils peuvent maintenir l’écran pour pause. ∞ = ils ferment quand ils veulent.",
  durationOpen: "∞ libre",
  seconds: "s",
  snapHoldHint: "Maintiens pour regarder · relâche pour le chrono",
  snapPaused: "pause",
  snapHoldClose: "maintiens · ✕ pour fermer",
  sendTo: "Envoyer à",
  selectFriends: "Choisir des amis",
  noCamera: "Permission caméra requise",
  emptyInbox: "Aucun snap en attente",
  emptyInboxBody: "Tu es à jour. Envoie un snap ou regarde les stories des amis.",
  emptyInboxCta: "Ouvrir la caméra",
  emptySentBody: "Tes snaps envoyés apparaissent ici — tape pour revoir.",
  emptyFriendsTitle: "Ta ruche est vide",
  emptyFriendsBody: "Cherche un @pseudo ou partage ton lien d'invitation.",
  emptyChatsTitle: "Pas encore de chats",
  emptyChatsBody: "Ajoute des amis d'abord, puis dis bonjour — ou ouvre un groupe.",
  emptyChatsCta: "Trouver des amis",
  from: "De",
  opened: "Ouvert",
  ...
  theyOpened: "Ouvert",
  yourSentSnap: "Ton snap",
  tapToViewSent: "Tape pour revoir",
  noRecipients: "Aucun destinataire",
  swipeErase: "Effacer",
  swipeEraseHint: "Glisse à gauche sur un snap pour l’effacer.",
  swipeEraseHintShort: "glisse ← pour effacer",
  snapErased: "Snap effacé",
  ...
  landHiveTitle: "Tu as un code ruche ?",
  landHiveBody:
    "Rejoins ta ruche d’école, de gang ou de ville — puis ajoute des amis.",
  onbMapTitle: "La carte est opt-in",
  onbMapBody:
    "Partage ton pin 1 h, jusqu’au soir, ou pas du tout. Fantôme = pas de tracking forever.",
  onbMapPoint1: "Mode ville pour une position approximative",
  onbMapPoint2: "Coupe quand tu veux via Plus → Carte",
  onbMapPoint3: "Alertes quand un ami te snap (push optionnel)",
  suggestions: "Peut-être que tu connais",
  suggestionsHint: "Via ruches ou groupes partagés — pas de pubs.",
  groupSettings: "Réglages du groupe",
  groupRename: "Sauver le nom",
  groupRenamed: "Groupe renommé",
  groupMembers: "Membres",
  groupKick: "Expulser",
  groupKicked: "Retiré du groupe",
  groupKickConfirm: "Retirer cette personne du groupe ?",
  groupLeave: "Quitter le groupe",
  groupLeft: "Tu as quitté le groupe",
  groupLeaveConfirm: "Quitter ce groupe ?",
  readReceipts: "Accusés de lecture",
  readReceiptsHint:
    "Cachés = tes amis ne voient pas « vu » (ton badge se vide quand même).",
  readReceiptsHidden: "Accusés cachés",
  readReceiptsShown: "Accusés on",
  mapGhostTip: "Astuce : partage fantôme 1 h ou soir — pas always-on.",
  ...
  colorPaletteHint: "Accent pour boutons, chips et glow.",
  edgeLighting: "Éclairage des bords",
  edgeLightingHint: "Cadre lumineux autour de l’app — vibe sans bruit.",
  edgeOff: "Off",
  edgeSoft: "Doux",
  edgePulse: "Pulse",
  edgeRainbow: "Arc-en-ciel",
  copy: "Copier",
  dualCaptionAdd: "Ajouter 2e langue",
  dualCaptionOn: "Double légende on",
  dualCaptionTitle: "Légendes bilingues",
  dualSwap: "Échanger les langues",
  dualPreview: "Ce que tes amis verront",
  dualTranslated: "2e langue remplie",
  captionEmpty: "Écris d’abord une légende",
  ...
  react: "Réagir",
  adminTitle: "Admin signalements",
  adminHint: "Examine les signalements. Bloque ou résous. La ruche d’abord.",
  adminOpen: "Ouverts",
  adminResolved: "Résolus",
  adminDismissed: "Rejetés",
  adminAll: "Tous",
  adminEmpty: "Aucun signalement dans ce filtre.",
  adminReporter: "Signaleur",
  adminNote: "Note",
  adminResolve: "Résoudre",
  adminDismiss: "Rejeter",
  adminReopen: "Rouvrir",
  adminUpdated: "Signalement mis à jour",
  adminBlockConfirm: "Bloquer cet utilisateur ?",
  textTool: "Texte",
  textToolHint: "Écris, puis tape la photo pour placer…",
  textToolTap: "Tape la photo pour coller le texte",
  textDefault: "ChatSnap",
  isTyping: "écrit…",
  mapShareHowLong: "Partager pendant",
  mapGhost1hBtn: "👻 1 heure",
  mapGhostEveningBtn: "🌙 Jusqu’au soir",
  mapShareOn: "Jusqu’à off",
  mapGhost1h: "Partage fantôme · 1 h",
  mapGhostEvening: "Partage fantôme · jusqu’au soir",
  mapUntil: "Visible jusqu’à",
  mapCoarseOff: "Mode ville seulement",
  mapCoarseOn: "Ville · on",
  mapCoarseBadge: "Position approximative",
  pushEnable: "Activer les push",
  pushEnabled: "Push actifs",
  pushUnavailable: "Push : installer / HTTPS + clé VAPID",
  pushOk: "Abonnement push enregistré",
  pushOff: "Push désactivés",
  hives: "Ruches",
  hivesHint:
