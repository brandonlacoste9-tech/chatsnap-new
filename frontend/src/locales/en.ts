export const en = {
  ...
  emptyInbox: "No snaps waiting",
  emptyInboxBody: "You're all caught up. Send a snap or swipe friends for stories.",
  emptyInboxCta: "Open camera",
  emptySentBody: "Snaps you send show up here — tap to re-view anytime.",
  emptyFriendsTitle: "Your hive is empty",
  emptyFriendsBody: "Search a @username or share your invite link to get the first friend.",
  emptyChatsTitle: "No chats yet",
  emptyChatsBody: "Add friends first, then say hi — or open a group.",
  emptyChatsCta: "Find friends",
  from: "From",
  opened: "Opened",
  ...
  swipeErase: "Erase",
  swipeEraseHint: "Swipe left on a snap to erase it.",
  swipeEraseHintShort: "swipe ← to erase",
  snapErased: "Snap erased",
  ...
  landHiveTitle: "Have a hive code?",
  landHiveBody: "Join your school, crew, or city hive — then add members as friends.",
  onbMapTitle: "Map is opt-in",
  onbMapBody:
    "Share your pin for 1 hour, until evening, or not at all. Ghost share = no forever tracking.",
  onbMapPoint1: "City-only mode for coarse location",
  onbMapPoint2: "Turn off anytime in More → Map",
  onbMapPoint3: "Alerts when friends snap you (optional push)",
  suggestions: "People you may know",
  suggestionsHint: "From shared hives or groups — not ads.",
  groupSettings: "Group settings",
  groupRename: "Save name",
  groupRenamed: "Group renamed",
  groupMembers: "Members",
  groupKick: "Kick",
  groupKicked: "Removed from group",
  groupKickConfirm: "Remove this person from the group?",
  groupLeave: "Leave group",
  groupLeft: "You left the group",
  groupLeaveConfirm: "Leave this group?",
  readReceipts: "Read receipts",
  readReceiptsHint:
    "When hidden, friends won’t see “seen” on your opens (you still clear your badge).",
  readReceiptsHidden: "Receipts hidden",
  readReceiptsShown: "Receipts on",
  mapGhostTip: "Tip: use 1h or evening ghost share — not always-on.",
  ...
  colorPaletteHint: "Accent for buttons, chips, and glows.",
  edgeLighting: "Edge lighting",
  edgeLightingHint: "Glow frame around the app — vibe without noise.",
  edgeOff: "Off",
  edgeSoft: "Soft",
  edgePulse: "Pulse",
  edgeRainbow: "Rainbow",
